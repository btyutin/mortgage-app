...
dependencies {
    ...
    implementation(project(":mortgage-webapp:mortgage-webapp-api"))
    implementation(project(":mortgage-contract:mortgage-contract-app"))
...
tasks {
    docker {
        name = "registry.weintegrator.com/mortgage/${project.name}"
