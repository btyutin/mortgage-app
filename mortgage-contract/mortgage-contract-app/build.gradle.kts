...
dependencies {
    ...
    api(project(":mortgage-contract:mortgage-contract-api"))
...
val dockerName = "registry.weintegrator.com/mortgage-sc/mortgage-contract-app"
...
val replaceImageId = tasks.create("replaceImageId") {
    doLast {
        ...
        if (imageId.isNotBlank()) {
            ...
            val path = "${project.rootProject.projectDir.absolutePath}/mortgage-webapp/mortgage-webapp-app/src/main/resources/application.yml"
